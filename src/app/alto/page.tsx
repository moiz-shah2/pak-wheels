      ...
      <div className="flex justify-center items-start p-6">
        <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-4xl">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm text-gray-700">
            ...
            <div className="bg-gray-50 p-2 rounded">Engine: <span className="float-right">660 CC</span></div>
            <div className="bg-gray-50 p-2 rounded">Condition: <span className="float-right">9 / 10</span></div>
            <div className="bg-gray-50 p-2 rounded">Driven: <span className="float-right">35,000 KM</span></div>
            <div className="bg-gray-50 p-2 rounded">Suspension Type: <span className="float-right">Soft</span></div>
            <div className="bg-gray-50 p-2 rounded">Avg: <span className="float-right">18 KM/L</span></div>
